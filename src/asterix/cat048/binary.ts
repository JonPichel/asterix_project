      ...
      if (bds1 == 4) {
        ...
        if (((data[3] >> 5) & 0b1) === 1) {
          ...
          record.bds40BarometricPressureSetting =
            (((data[3] & 0b11111) << 7) | (data[4] >> 1)) * 0.1 // mb
        }
        if ((data[5] & 0b1) === 1) {
        ...
        if (((data[0] >> 7) & 0b1) === 1) {
          ...
          record.bds50Roll =
            (sign * (((data[0] & 0b111111) << 3) | (data[1] >> 5)) * 45) / 256 // º
        }
        if (((data[1] >> 4) & 0b1) === 1) {
          const sign = ((data[1] >> 3) & 0b1) === 1 ? -1 : 1
          record.bds50TrueTrack =
            (sign * (((data[1] & 0b111) << 7) | (data[2] >> 1)) * 90) / 512 // º
        }
        if ((data[2] & 0b1) === 1) {
        ...
        if (((data[4] >> 5) & 0b1) === 1) {
          ...
          record.bds50TrackRate =
            (sign * (((data[4] & 0b1111) << 5) | (data[5] >> 3)) * 8) / 256 // º/s
        }
        if (((data[5] >> 2) & 0b1) === 1) {
        ...
        if (((data[0] >> 7) & 0b1) === 1) {
          ...
          record.bds60MagneticHeading =
            (sign * (((data[0] & 0b111111) << 4) | (data[1] >> 4)) * 90) / 512 // º
        }
        if (((data[1] >> 3) & 0b1) === 1) {
        ...
        if (((data[4] >> 5) & 0b1) === 1) {
          ...
          record.bds60BarometricAltitudeRate =
            (sign * (((data[4] & 0b1111) << 5) | (data[5] >> 3)) * 8192) / 256 // ft/min
        }
        if (((data[5] >> 2) & 0b1) === 1) {
          const sign = ((data[5] >> 1) & 0b1) === 1 ? -1 : 1
          record.bds60InertialVerticalVelocity =
            (sign * (((data[5] & 0b1) << 8) | data[6]) * 8192) / 256 // ft/min
        }
      }
    }
  }
